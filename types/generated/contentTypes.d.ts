...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    application_fee: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_event_types: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiUserEventTypeUserEventType
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_event_types';
  info: {
    description: '';
    displayName: 'event';
    pluralName: 'user-event-types';
    singularName: 'user-event-type';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    saldo_active: Schema.Attribute.String;
    saldo_refund: Schema.Attribute.String;
    serviceLocation: Schema.Attribute.JSON;
